...
import { handleGeminiStreamingResponse } from './geminiStreamAccumulate';
...
// Supported models
const SUPPORTED_MODELS = ["gemini-3.8-flash", "gemini-3.7-flash", "gemini-3.5-flash-lite", "gemini-3.1-flash-lite"];
 ...
 * @param {string} model - The model identifier (supports "gemini-3.8-flash", "gemini-3.7-flash", or "gemini-3.5-flash-lite").
